...
const {
  createRegion, findAllRegions, findRegionById, deleteRegionById, updateRegionById,
} = require('../service/regionService');
...
const updateRegionByIdHandler = asyncHandler(async (req, res) => {
  ...
  const { id } = await updateRegionById(req.body, regionId);
